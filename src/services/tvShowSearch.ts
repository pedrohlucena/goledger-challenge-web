...
export async function getTvShowSearchResults(query: string): Promise<TvShowSearchData> {
  ...
  const results = allTvShows.filter((tvShow) => matchesTitleQuery(tvShow, normalizedQuery));
